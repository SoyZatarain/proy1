...
class Arbol:
    ...
    def ensamblarEtiquetaA(self):
        self.ensamblar("SYMBOL_OPENTAGS")
        self.ensamblar("HTML_TAG_A_OPEN")
        self.ensamblar("ATTR_NAME")
        self.ensamblar("SYMBOL_EQUALSYM")
        self.ensamblar("SYMBOL_DOBQUOTE")
        self.ensamblar("ATTR_VALUE")
        self.ensamblar("SYMBOL_DOBQUOTE")
        self.ensamblar("SYMBOL_CLOSETAG")
        self.ensamblar("HTML_INNERTEXT")
        self.ensamblar("SYMBOL_OPENTAGS")
        self.ensamblar("SYMBOL_DIAGONAL")
        self.ensamblar("HTML_TAG_A_CLOSE")
        atributoInterno = diccionarios.Atributo(self.estructuraActual[2].valor, self.estructuraActual[5].valor)
        return diccionarios.Etiqueta(self.estructuraActual[1].valor, [atributoInterno])